...
> Nota 2: Formato del código externo de Orden: M########### (para MAC: son 14 caracteres en total, comienzan con el caracterer M y luego el número de servicio completado con hasta 13 ceros a izquierda). 
...
| FECHA_Y_HORA_DE_CREACION_DE_LA_ORDEN | |
| MEDIDORS | |
...
| ZONA | |
| **Request.DATOS_COMUNES_PROCESOS_TDC.MEDIDORS** | |
| MARCA_MEDIDOR | |
| MODELO_MEDIDOR | |
| NUMERO_MEDIDOR | |
| TIPO_MEDIDOR | |
| UBICACION_DEL_MEDIDOR | |
| VALOR_TENSION_NOMINAL | |
| **Request.DATOS_COMUNES_PROCESOS_TDC.SELLOS** | |
| COLOR_DEL_SELLO | |
| SELLOS_EN_SISTEMA | |
| TIPO_DE_SELLO | |
| UBICACION_DEL_SELLO | |
| SERIE_SELLO | |
| **Request.DATOS_COMUNES_PROCESOS_TDC.SUMINISTROS** | |
| ANTIGUEDAD  |
| CODIGO_CLIENTE | | 
| CODIGO_POSTAL | |
| DEUDA | |
